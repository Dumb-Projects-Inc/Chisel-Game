...
class MovingWallDemo extends Module {
  ...
  backWall.io.p1 := Vec2(160.U - wallWidth, top)
  backWall.io.p2 := Vec2(160.U + wallWidth, bottom)
  ...
  leftWall.io.p2 := Vec2(160.U - wallWidth, top)

  // RIGHT WALL
  val rightWall = Module(new NewWallEntity(doomPalette.length, 14))
  rightWall.io.x := DontCare
  rightWall.io.y := DontCare
  rightWall.io.p1 := Vec2(319.U, 0.U)
  rightWall.io.p2 := Vec2(160.U + wallWidth, top)
